        ...
        <div className="flex min-h-screen w-full items-center justify-center p-4 bg-[#0a0e17] font-inter">
            <div className="w-full max-w-md bg-[#131823] border border-white/5 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="mb-8 text-center">
                    <h1 className="text-3xl font-bold text-white mb-2 font-outfit">Login</h1>
                    ...
                    {message && (
                        <div className="mt-4 p-3 bg-green-500/10 border border-green-500/20 rounded-xl text-green-400 text-xs text-left">
                            {message}
                        </div>
                    )}
                </div>
                ...
                <form className="grid gap-5">
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="/reset-password" className="text-sm text-[#00d4ff] hover:text-cyan-300 transition">
                                Forgot password?
                            </Link>
                        </div>
                        <Input
                    ...
                    <Button formAction={login} className="w-full bg-[#00d4ff] hover:bg-[#00b8e6] text-black font-bold text-base py-6 rounded-xl mt-2 transition-all">
                        Login
                    </Button>
                    ...
                    <div className="mt-4 text-center text-sm text-gray-400">
                        ...
                        <Link href="/signup" className="text-white hover:text-[#00d4ff] transition underline-offset-4 hover:underline">
                            Sign Up
                        </Link>
                    </div>
                </form>
